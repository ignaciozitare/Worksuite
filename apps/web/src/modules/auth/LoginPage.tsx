...
const S: Record<string, React.CSSProperties> = {
  root: {
    ...
    justifyContent: 'center', background: '#0d0d10', padding: 16,
  },
  card: {
    width: '100%', maxWidth: 380, background: '#141418',
    border: '1px solid #2a2a38', borderRadius: 12,
    padding: '36px 32px', boxShadow: '0 8px 30px rgba(0,0,0,.55)',
  },
  logo: {
  ...
  dot: {
    ...
    background: '#4f6ef7', boxShadow: '0 0 10px #4f6ef7',
  },
  ...
  label:{ fontSize: 11, fontWeight: 600, letterSpacing: '.08em',
          textTransform: 'uppercase', color: '#50506a' },
  input:{
    background: '#1b1b22', border: '1px solid #2a2a38', borderRadius: 6,
    padding: '9px 12px', color: '#e4e4ef', fontSize: 13, outline: 'none',
    fontFamily: 'inherit', transition: 'border-color .15s',
  },
  error:{
    background: 'rgba(224,82,82,.08)', border: '1px solid rgba(224,82,82,.25)',
    borderRadius: 6, padding: '8px 12px', color: '#e05252', fontSize: 12,
  },
  btn: {
    background: '#4f6ef7', border: 'none', borderRadius: 6, color: '#fff',
